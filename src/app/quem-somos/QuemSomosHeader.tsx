        ...
        <div className="pt-8 flex flex-wrap justify-center gap-3">
          {submenus.map((item) => (
            <a 
              key={item.id} 
              href={`#${item.id}`}
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full border border-primary/30 bg-primary-soft/10 hover:bg-primary/20 text-sm font-medium transition-colors"
            >
              {item.name}
